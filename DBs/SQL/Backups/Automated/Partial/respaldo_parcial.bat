...
set BACKUP_FILE=%BACKUP_DIR%\backup_parcial_%date:~-4,4%-%date:~-7,2%-%date:~-10,2%_%time:~0,2%-%time:~3,2%.sql
...
:: Respaldo parcial
"%MYSQLDUMP%" -u %DB_USER% -p%DB_PASSWORD% -P 3306 %DB_NAME% equipamiento > "%BACKUP_FILE%"
